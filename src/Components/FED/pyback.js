...
import pyback from '../Images/BACKEND DEVELOPER ROAD MAP-MODULE 1.9f2ef0f177720b4be00b.png';
...
const Pybackend = () => {
    return (
        ...
        <div>
            ...
            <p>Python is an interpreted, object-oriented, high-level programming language with dynamic semantics developed by Guido van Rossum.</p>
        </div>
        ...
        <div className='mern-image-container'>
            <img src={pyback} alt='MERN Stack Roadmap' />
        </div>
    </div>
    );
};

export default Pybackend;