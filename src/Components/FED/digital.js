...
import digital from '../Images/BUSINESS ANALYST ROAD MAP.286bad1c4dd42dd454bb.png'
...
const Digital = () => {
    return (
        ...
        <div>
            ...
            <p>Digital marketing involves promoting products or services using digital channels.</p>
        </div>
        ...
        <div className='mern-image-container'>
            <img src={digital} alt='MERN Stack Roadmap' />
        </div>
    </div>
    );
};
